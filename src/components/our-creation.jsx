      ...
      <div className="grid gap-8 grid-rows-[auto] grid-cols-[1fr]">
        <div className="gap-8 justify-between items-stretch flex flex-col lg:flex-row">
          <a href="#" className="relative overflow-hidden">
            <div
              id="w-node-_2ed66087-ae3a-eb52-4bdb-addec7732ce7-673e5f2a"
              className="w-full h-full flex-col justify-center items-center flex absolute inset-0"
            >
              <img
            ...
            <div className="h-full min-h-[70vh] flex-col justify-end flex relative p-8">
              <h3 className="font-grand-wilson-sans text-3xl font-bold text-[#e8e8e8]">
                Crimson Canyon
                <br />
              </h3>
            </div>
